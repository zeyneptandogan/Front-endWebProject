        ...
        return(
            ...
            <>
                ...
                <div className="card_big">
                    <div className="imgBx_big">
                        <Link className='lnk' key={props.product.productId} to={'/product_detail/'+ props.product.productId}>
                            <img className="image_Card_big" src={props.product.imgUrl} alt="" width="125" height="250" />
                        </Link>
                    </div>
                    <div className="contentBx_big">
                        <Link className='lnk' key={props.product.productId} to={'/product_detail/'+ props.product.productId}>
                            <h3>{props.product.productName}</h3>
                        </Link>
                        <h2>{props.product.writer}</h2>
                        <strong className="price_big"> ₺{props.product.currentPrice} <span>  ₺{props.product.initialPrice}</span> </strong>

                    </div>
                    {props.product.currentStock === 0 &&
                    <p className="contentBx2_big">
                        <span>Sold Out!!!</span>
                    </p>
                    }
        ...
        return (
            <>
                <div className="card_big">
                    <div className="imgBx_big">
                        <Link className='lnk' key={props.product.productId} to={'/product_detail/'+ props.product.productId}>
                            <img className="image_Card_big" src={props.product.imgUrl} alt="" width="100" height="200" />
                        </Link>
                    </div>
                    <div className="contentBx_big">
                        <Link className='lnk' key={props.product.productId} to={'/product_detail/'+ props.product.productId}>
                        ...
                        <h2>{props.product.writer}</h2>
                        <strong className="price_notdiscount_big"> ₺{props.product.currentPrice}</strong>
